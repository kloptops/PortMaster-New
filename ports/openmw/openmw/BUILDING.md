...
cmake .. \
    ...
    -DBUILD_LAUNCHER=OFF -DBUILD_WIZARD=OFF -DBUILD_OPENCS=OFF -DBUILD_OPENCS_TESTS=OFF -DBUILD_ESSIMPORTER=OFF -DBUILD_BULLETOBJECTTOOL=OFF -DBUILD_MWINIIMPORTER=OFF -DBUILD_DOCS=OFF -DBUILD_ESMTOOL=OFF -DBUILD_BSATOOL=ON -DBUILD_NIFTEST=OFF -DBUILD_NAVMESHTOOL=ON -DBUILD_OSG_DEPRECATED_SERIALIZE=OFF \
